...
//  if (node == NULL) {
//    t = new AVLNode;
//    t->data.SetHandle(key.getHandel());
//    t->height = 1;
//    t->left = t->right = NULL;
//    t->data.displayInfo();
